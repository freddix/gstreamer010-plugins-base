...
Group:		Libraries
Provides:	gstreamer-plugins-base-libs = %{version}-%{release}
Obsoletes:	gstreamer-plugins-base-libs < %{version}-%{release}
...
Requires:	%{name}-libs = %{version}-%{release}
Requires:	gstreamer010-devel >= %{gst_req_ver}
Provides:	gstreamer-plugins-base-devel = %{version}-%{release}
Obsoletes:	gstreamer-plugins-base-devel < %{version}-%{release}
...
Provides:	gstreamer-plugins-base-apidocs = %{version}-%{release}
Obsoletes:	gstreamer-plugins-base-apidocs < %{version}-%{release}
